...
* 🔭 I’m currently working on building scalable APIs and improving application performance.
* 🌱 I’m currently deepening my knowledge in Cloud Native technologies (Docker, Kubernetes) and exploring Golang.
* 👯 I’m looking to collaborate on impactful open-source projects, especially those relevant to the African tech ecosystem.
* 🤔 I’m looking for help with advanced DevOps practices.
* 💬 Ask me about: Python (Django/Flask), JavaScript (React/Node.js), RESTful APIs, database design, or Agile methodologies.
* Mantu yangye/My Goal: To leverage technology to create solutions that drive positive change and innovation in Rwanda and beyond.
* ⚡ Fun fact: When I'm not coding, I enjoy hiking the hills around Kigali and experimenting with Rwandan coffee brewing methods! ☕
...
<p>
    ...
    <img alt="Pytest" src="https://img.shields.io/badge/Pytest-0A9B70?style=for-the-badge&logo=pytest&logoColor=white"/>
</p>
